...
public class ContactList implements Iterable<Contact> {
      ...
      // data fields for ContactList class
      private Contact[] arr;
      private int logicalLength;

      // ContactList constructors

      // NoArgs constructor with capacity set to 10
      public ContactList() {
            this(10);
      }

      // constructor with user defined capacity initialization
      public ContactList(int initialCapacity) {
            arr = new Contact[initialCapacity];
            logicalLength = 0;
      }

      // constructor wit user provided user array
      ...
      /*
       * A method that allows you to add a Contact to the ContactList. You should only
       * add a Contact to the list if it is not there already.
       */
      ...
      /*
       * delete the whole contact list or that's what the user thinks
       */
      public void clearConatctList() {
            logicalLength = 0;
      }

      // get contact at a specific index
      ...
      // get the index number of the given contact
      ...
      // method that returns the size of the ContactList
      public int size() {
       ...
       * another if they contain the same Contacts (but not necessarily in the same
       * order.)
       */
      @Override
      ...
      /*
       * A method that searches for a Contact by phone number, and returns a reference
       * to the Contact. If there is no such Contact, a sentinel value should be
       * returned.
       */
       ...
       * Contacts with a last name starting with a particular letter. If there are no
       * such Contacts, you should return the empty ContactList.
       */
